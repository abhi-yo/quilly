    ...
    <div className="w-full max-w-md mx-auto space-y-6">
      ...
      <div className="bg-gray-900/40 border border-gray-800 rounded-lg p-6">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button className="w-full flex items-center justify-center gap-2 bg-gray-800 text-white text-sm font-medium py-2.5 px-4 rounded-lg hover:bg-gray-700 transition-colors">
