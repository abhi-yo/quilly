          ...
          setArticles([
            {
              ...
              content:
                "Discover the best alternatives to Postman for API testing and development. From open-source tools to enterprise solutions, we cover everything you need to know about modern API clients and how they can streamline your development workflow.",
              author: "AKSHAT",
            ...
            },
            {
              ...
              content:
                "Learn how to build scalable and performant web applications using Next.js 14, React Server Components, and modern development practices for production-ready applications that scale.",
              author: "JANE DOE",
            ...
            },
            {
              _id: "3",
              title:
                "Supercharge Your Coding Mojo: Connecting This FREE MCP Server",
              content:
                "Boost your development workflow with this powerful MCP server integration. Free, easy to set up, and incredibly useful for modern developers who want to enhance their productivity.",
              author: "ANONYMOUS",
            ...
            },
            {
              ...
              content:
                "Exploring how artificial intelligence is transforming the way we write, test, and deploy software in 2024 and beyond. From code generation to automated testing.",
              author: "ALEX CHEN",
            ...
            },
            {
              ...
              content:
                "Deep dive into advanced TypeScript patterns, utility types, and best practices for building type-safe applications that scale with your team.",
              author: "SARAH MILLER",
            ...
            },
            {
              ...
              content:
                "Essential database design principles and patterns for building applications that scale efficiently with growing user bases and increasing data volumes.",
              author: "DAVID WANG",
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-8">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Discover stories, insights, and ideas from our vibrant community
        ...
        <div className="mb-6">
          <p className="text-gray-400 text-base">
            ...
            {selectedTag && (
              <span className="ml-2">
                in{" "}
                <span className="text-white font-medium">#{selectedTag}</span>
              </span>
            )}
          </p>
        </div>
