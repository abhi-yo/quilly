...
import { Search, Plus, Calendar, User, Eye, MessageCircle, Edit, Trash2 } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto p-8">
        <div className="flex items-center justify-between mb-8">
            ...
            <p className="text-gray-400 text-lg">
              {isWriter ? "Manage your articles and explore content from other writers" : "Discover amazing content from our community of writers"}
            </p>
            </div>
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-gray-950/50 rounded-2xl p-6 animate-pulse border border-gray-800/50 h-80">
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">
              {searchTerm ? "No articles found" : isWriter ? "No articles yet" : "No articles available"}
            </h3>
